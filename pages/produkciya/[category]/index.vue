...
<script setup>
    ...
    const subCategories = computed(() => {
        return categories.data.subcategories.map((subCategory) => {
            return {
                ...
                link: `/produkciya/${route.params.category}/${subCategory.slug}`,
    ...
    useHead({
        ...
        meta: [
            { name: 'description', content: catalogStore.targetCategory.seoBlock.seoDescription },
            { name: 'robots', content: `${catalogStore.targetCategory.seoBlock.seoNoindex ? 'noindex' : 'index'},${catalogStore.targetCategory.seoBlock.seoNofollow ? 'nofollow' : 'follow'}` }
        ],
        link: [
            { rel: 'canonical', href: catalogStore.targetCategory.seoBlock.canonicalUrl }
        ]
    })
