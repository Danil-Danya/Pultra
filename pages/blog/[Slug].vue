...
<script setup>
    ...
    const breadCrumbsList = ref([
        ...
        {
            link: '/blog',
            text: 'Применение композитных материалов в строительстве для усиления конструкций'
        }
    ])
    ...
    useHead({
        title: 'Применение композитных материалов в строительстве для усиления конструкций',
