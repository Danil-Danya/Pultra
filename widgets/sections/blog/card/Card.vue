<template>
    <div class="blog__card">
        <NuxtLink :to="link" class="blog__image-link">
            <NuxtImg  loading="lazy"  preset="default"  format="webp" :src="image" alt="Превью" class="blog__image" />
        </NuxtLink>
...
<script setup>
    ...
    const ArrowButton = defineAsyncComponent(() => import('@/shared-ui/icons/blog/Arrow.vue'));
...
<style lang="scss">
    @import '@/assets/styles/ui/shared/widgets/blog/blog-card.scss';
</style>